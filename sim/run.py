...
if __name__ == "__main__":
	...
	testbed.set_crop_box(np.array([[1.51, 0., 0., 0.], [0., 1.51, 0., 0.], [0., 0., 0.31, 0.35]])) # Sets the crop box to size 1
	...
	if args.save_mesh:
		...
		testbed.compute_and_save_marching_cubes_mesh(args.save_mesh + '.obj', [res, res, res], thresh=thresh)
		testbed.compute_and_save_marching_cubes_mesh(args.save_mesh + '.ply', [res, res, res], thresh=thresh)
